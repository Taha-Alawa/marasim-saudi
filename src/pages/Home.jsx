      ...
      <section className="hero">
        <div className="hero-content">
          <motion.div
            ...
            <p> شركة نقل تفخر بتقديم خدمات متميزة لعملائها. نهتم بتقديم تجربة فريدة ومريحة لزوار بيت الله الحرام والمسجد النبوي وتقديم برامج سياحية لمختلف الزوار في جميع أنحاء المملكة العربية السعودية، حيث يكون الأمان والراحة هما الأساسيان في جميع جوانب خدماتنا</p>
          </motion.div>
